...
public class InternalMediaCodecUtilTest {
    ...
    private final MediaCodecInfo secondMediaCodec = MediaCodecInfo.newInstance("second.codec.name", "video/mp4", "", null, false, true);
    private final MediaCodecInfo thirdMediaCodec = MediaCodecInfo.newInstance("third.codec.name", "video/mp4", "", null, false, true);
